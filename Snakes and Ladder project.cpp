...
int main(){
    ...
    system("CLS");
    if (g==1){cout<< P1.names()<<" won by reaching to the end first"<<endl;}
    if (g==2){cout<< P2.names()<<" won by reaching to the end first"<<endl;}
    if (g==3){cout<< P2.names()<<" won by default due to "<<P1.names()<<" died"<<endl;}
    if (g==4){cout<< P1.names()<<" won by default due to "<<P2.names()<<" died"<<endl;}
    print(t,P1,P2,x);
    return 0;
    }
